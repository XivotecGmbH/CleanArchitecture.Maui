...
/// </summary>
public record GetToDoListListQuery : IRequest<List<ToDoListDto>>;

public class GetToDoListListHandler : IRequestHandler<GetToDoListListQuery, List<ToDoListDto>>
{
    ...
    public async Task<List<ToDoListDto>> Handle(GetToDoListListQuery request, CancellationToken cancellationToken)
    {
        try
        {
